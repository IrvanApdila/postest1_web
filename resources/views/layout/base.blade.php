...
<body>
    <nav class="navbar navbar-expand-lg" style= "background-color: #7952b3";>
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fab fa-bootstrap fa-2x " style="color: rgb(246, 246, 246);"></i></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="berita" style="color: white;">Berita Musik</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="artis" style="color: white;">Artis atau Band</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="/myblog" style="color: white;">Blog</a>
                    </li>
                ...
                <ul>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="" style="color: white;"><i class="fab fa-github"></i></a>
                        </li>
